...
},{"./isArguments":28}],24:[function(require,module,exports) {
...
},{"object-keys":23,"foreach":24}],45:[function(require,module,exports) {
...
},{"./implementation":45}],37:[function(require,module,exports) {
var e=require("function-bind");module.exports=e.call(Function.call,Object.prototype.hasOwnProperty);
},{"function-bind":39}],40:[function(require,module,exports) {
...
},{"./helpers/isPrimitive":40,"is-callable":41,"is-date-object":42,"is-symbol":43}],30:[function(require,module,exports) {
...
},{"./helpers/isPrimitive":40,"is-callable":41}],29:[function(require,module,exports) {
...
},{"./helpers/isNaN":30,"./helpers/isFinite":31,"./helpers/sign":33,"./helpers/mod":34,"is-callable":41,"es-to-primitive/es5":44,"has":37}],36:[function(require,module,exports) {
...
},{"has":37}],27:[function(require,module,exports) {
...
},{"has":37,"es-to-primitive/es6":38,"./helpers/isNaN":30,"./helpers/isFinite":31,"./helpers/assign":32,"./helpers/sign":33,"./helpers/mod":34,"./helpers/isPrimitive":40,"function-bind":39,"./es5":29,"is-regex":36}],22:[function(require,module,exports) {
...
},{"es-abstract/es6":22,"define-properties":15}],10:[function(require,module,exports) {
...
},{"es-abstract/es6":22,"./implementation":9}],11:[function(require,module,exports) {
...
},{"../vendor/xhook":4,"./config":20}],26:[function(require,module,exports) {
var e=require("../vendor/xhook"),t=require("./config"),r=require("./util"),a=r.log,o=r.warn,s=r.toRegExp,n=r.strip,i=r.parseUrl,d=r.COMPAT_VERSION,u=!1,l={};exports.addMasters=function(e){if(window!==window.parent)for(var t in u||(u=!0,a("now handling incoming sockets..."),window.parent.postMessage("XDPING_"+d,"*")),e){var r=e[t];"file://"===t&&"*"!==r&&(o("file protocol only supports the * path"),r="*"),a("adding master: "+t),l[t]=r}else o("slaves must be in an iframe")},t.masters=exports.addMasters,exports.handleSocket=function(t,r){if(u){"null"===t&&(t="file://"),a('handle socket for "'+t+'"');var d=null;for(var p in l){var c=l[p];try{if(s(p).test(t)){d=s(c);break}}catch(e){}}d?(r.once("request",function(t){a("request: "+t.method+" "+t.url);var s=i(t.url);if(!s||!d.test(s.path))return o("blocked request to path: '"+s.path+"' by regex: "+d),void r.close();var u=new XMLHttpRequest;for(var l in u.open(t.method,t.url),u.addEventListener("*",function(e){return r.emit("xhr-event",e.type,n(e))}),u.upload&&u.upload.addEventListener("*",function(e){return r.emit("xhr-upload-event",e.type,n(e))}),u.onreadystatechange=function(){if(4===u.readyState){var t={status:u.status,statusText:u.statusText,data:u.response,headers:e.headers(u.getAllResponseHeaders())};try{t.text=u.responseText}catch(e){}return r.emit("response",t)}},r.once("abort",function(){return u.abort()}),t.withCredentials&&(u.withCredentials=!0,t.slaveCookie&&(t.headers[t.slaveCookie]=document.cookie)),t.timeout&&(u.timeout=t.timeout),t.type&&(u.responseType=t.type),t.headers){var p=t.headers[l];u.setRequestHeader(l,p)}if(t.body instanceof Array&&"XD_FD"===t.body[0]){var c=new e.FormData,f=t.body[1];Array.from(f).forEach(function(e){if("XD_BLOB"===args[0]&&4===args.length){var t=new Blob([args[2]],{type:args[3]});args=args[1],args[1]=t}c.append.apply(c,args)}),t.body=c}u.send(t.body||null)}),a("slave listening for requests on socket: "+r.id)):o("blocked request from: '"+t+"'")}};
...
},{"../vendor/xhook":4,"./config":20,"./util":17,"./slave":26}],25:[function(require,module,exports) {
var r=function(){return function(r,e){if(Array.isArray(r))return r;if(Symbol.iterator in Object(r))return function(r,e){var n=[],t=!0,i=!1,o=void 0;try{for(var a,u=r[Symbol.iterator]();!(t=(a=u.next()).done)&&(n.push(a.value),!e||n.length!==e);t=!0);}catch(r){i=!0,o=r}finally{try{!t&&u.return&&u.return()}finally{if(i)throw o}}return n}(r,e);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}(),e=require("../vendor/xhook"),n=require("./config"),t=require("./util"),i=t.currentOrigin,o=t.log,a=t.warn,u=t.parseUrl,s=t.guid,c=t.strip,d=require("./socket"),f=d.createSocket,l=!1,v={};exports.addSlaves=function(r){for(var n in l||(l=!0,"addWithCredentials"in e||(e.addWithCredentials=!0),e.before(y)),r){var t=r[n];o("adding slave: "+n),v[n]=t}},n.slaves=exports.addSlaves;var y=function(r,e){var n=u(r.url);if(n&&n.origin!==i){if(!v[n.origin])return n&&o("no slave matching: '"+n.origin+"'"),void e();if(o("proxying request to slave: '"+n.origin+"'"),!1===r.async)return a("sync not supported because postmessage is async"),void e();var t=h(n.origin,v[n.origin]),c=f(s(),t);c.on("response",function(r){e(r),c.close()}),r.xhr.addEventListener("abort",function(){return c.emit("abort")}),c.ready?g(r,c):c.once("ready",function(){return g(r,c)})}else e()},p={},h=function(r,e){if(p[r])return p[r];var n=document.createElement("iframe");return n.id=n.name=s(),o("creating iframe "+n.id),n.src=""+r+e,n.setAttribute("style","display:none;"),document.body.appendChild(n),p[r]=n.contentWindow},m=function(e,n){var t=Array.from(e),i=r(t,2),o=(i[0],i[1]),a=instOf(o,"Blob"),u=instOf(o,"File");if(!a&&!u)return 0;var s=new FileReader;return s.onload=function(){return e[1]=null,u&&(e[2]=o.name),n(["XD_BLOB",e,this.result,o.type])},s.readAsArrayBuffer(o),1},b=function(e,n){e.forEach(function(n,t){var i=Array.from(n),o=r(i,2),a=o[0],u=o[1];instOf(u,"FileList")&&(e.splice(t,1),Array.from(u).forEach(function(r){e.splice(t,0,[a,r])}))});var t=0;e.forEach(function(r,i){t+=m(r,function(r){e[i]=r,0==--t&&n()})}),0===t&&n()},g=function(r,e){e.on("xhr-event",function(){return r.xhr.dispatchEvent.apply(null,arguments)}),e.on("xhr-upload-event",function(){return r.xhr.upload.dispatchEvent.apply(null,arguments)});var t=c(r);t.headers=r.headers,r.withCredentials&&(n.cookies.master&&(t.headers[n.cookies.master]=document.cookie),t.slaveCookie=n.cookies.slave);var i=function(){return e.emit("request",t)};if(r.body&&(t.body=r.body,instOf(t.body,"FormData"))){var o=t.body.entries;return t.body=["XD_FD",o],void b(o,i)}i()};
...
},{"./config":20,"./util":17,"./master":25,"./slave":26}],3:[function(require,module,exports) {
...
Array.from||(Array.from=require("array.from"));var r=require("./vendor/xhook");window.xhook=r;var o=require("./index");window.xdomain=o;
