...
},{"./isArguments":30}],27:[function(require,module,exports) {
...
},{"./implementation":48}],40:[function(require,module,exports) {
...
},{"./helpers/isPrimitive":43,"is-callable":44,"is-date-object":45,"is-symbol":46}],33:[function(require,module,exports) {
...
},{"./helpers/isNaN":33,"./helpers/isFinite":35,"./helpers/sign":36,"./helpers/mod":37,"is-callable":44,"es-to-primitive/es5":47,"has":40}],39:[function(require,module,exports) {
...
},{"has":40}],31:[function(require,module,exports) {
...
},{"has":40,"es-to-primitive/es6":41,"./helpers/isNaN":33,"./helpers/isFinite":35,"./helpers/assign":34,"./helpers/sign":36,"./helpers/mod":37,"./helpers/isPrimitive":43,"function-bind":42,"./es5":32,"is-regex":39}],25:[function(require,module,exports) {
"use strict";module.exports=require("./es2015");
},{"./es2015":31}],9:[function(require,module,exports) {
...
var e,t,n,r,o,i,s,a,u,d,f,c,l,p,h,y,v,g,w,m,b,x,T,L,C,R="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},E=[].indexOf||function(e){for(var t=0,n=this.length;t<n;t++)if(t in this&&this[t]===e)return t;return-1};g=window.document,t="before",e="after",f="readyState",d="addEventListener",u="removeEventListener",o="dispatchEvent",h="XMLHttpRequest",i="FormData",c=["load","loadend","loadstart"],n=["progress","abort","error","timeout"],b=parseInt((/msie (\d+)/.exec(navigator.userAgent.toLowerCase())||[])[1]),isNaN(b)&&(b=parseInt((/trident\/.*; rv:(\d+)/.exec(navigator.userAgent.toLowerCase())||[])[1])),(C=Array.prototype).indexOf||(C.indexOf=function(e){var t,n,r;for(t=n=0,r=this.length;n<r;t=++n)if(this[t]===e)return t;return-1}),T=function(e,t){return Array.prototype.slice.call(e,t)},v=function(e){return"returnValue"===e||"totalSize"===e||"position"===e},m=function(e,t){var n;for(n in e)if(e[n],!v(n))try{t[n]=e[n]}catch(e){}return t},x=function(e,t,n){var r,i,s,a;for(i=function(e){return function(r){var i,s,a;for(s in i={},r)v(s)||(a=r[s],i[s]=a===t?n:a);return n[o](e,i)}},s=0,a=e.length;s<a;s++)r=e[s],n._has(r)&&(t["on"+r]=i(r))},w=function(e){var t;if(null!=g.createEventObject)return(t=g.createEventObject()).type=e,t;try{return new Event(e)}catch(t){return{type:e}}},(L=(r=function(e){var t,n,r;return n={},r=function(e){return n[e]||[]},(t={})[d]=function(e,t,o){n[e]=r(e),n[e].indexOf(t)>=0||(o=void 0===o?n[e].length:o,n[e].splice(o,0,t))},t[u]=function(e,t){var o;void 0!==e?(void 0===t&&(n[e]=[]),-1!==(o=r(e).indexOf(t))&&r(e).splice(o,1)):n={}},t[o]=function(){var n,o,i,s,a,u,d,f;for(("readystatechange"===(o=(n=T(arguments)).shift())||"progress"===o)&&n.length&&n[0]&&n[0].currentTarget&&(i=n.shift()),e||(n[0]=m(n[0],i||w(o))),(a=t["on"+o])&&a.apply(t,n),s=u=0,d=(f=r(o).concat(r("*"))).length;u<d;s=++u)f[s].apply(t,n)},t._has=function(e){return!(!n[e]&&!t["on"+e])},e&&(t.listeners=function(e){return T(r(e))},t.on=t[d],t.off=t[u],t.fire=t[o],t.once=function(e,n){var r;return r=function(){return t.off(e,r),n.apply(null,arguments)},t.on(e,r)},t.destroy=function(){return n={}}),t})(!0)).EventEmitter=r,L[t]=function(e,n){if(e.length<1||e.length>2)throw"invalid hook";return L[d](t,e,n)},L[e]=function(t,n){if(t.length<2||t.length>3)throw"invalid hook";return L[d](e,t,n)},L.enable=function(){window[h]=p,s&&(window[i]=l)},L.disable=function(){window[h]=L[h],s&&(window[i]=s)},y=L.headers=function(e,t){var n,r,o,i,s,a,u,d,f;switch(null==t&&(t={}),void 0===e?"undefined":R(e)){case"object":for(o in r=[],e)s=e[o],i=o.toLowerCase(),r.push(i+":\t"+s);return r.join("\n");case"string":for(u=0,d=(r=e.split("\n")).length;u<d;u++)n=r[u],/([^:]+):\s*(.+)/.test(n)&&(i=null!=(f=RegExp.$1)?f.toLowerCase():void 0,a=RegExp.$2,null==t[i]&&(t[i]=a));return t}},s=window[i],l=function(e){var t,n;this.fd=e?new s(e):new s,this.form=e,t=[],Object.defineProperty(this,"entries",{get:function(){return(e?T(e.querySelectorAll("input,select")).filter(function(e){var t;return"checkbox"!==(t=e.type)&&"radio"!==t||e.checked}).map(function(e){return[e.name,"file"===e.type?e.files:e.value]}):[]).concat(t)}}),this.append=(n=this,function(){var e;return e=T(arguments),t.push(e),n.fd.append.apply(n.fd,e)})},s&&(L[i]=s,window[i]=l),a=window[h],L[h]=a,p=window[h]=function(){var i,s,a,u,p,v,g,w,T,C,O,S,A,M,j,H,U,N,k,q;U=new L[h],A=null,v=void 0,M=void 0,O=void 0,T=function(){var e,t,n,r;if(O.status=A||U.status,-1===A&&b<10||(O.statusText=U.statusText),-1!==A)for(e in r=y(U.getAllResponseHeaders()))n=r[e],O.headers[e]||(t=e.toLowerCase(),O.headers[t]=n)},w=function(){U.responseType&&"text"!==U.responseType?"document"===U.responseType?(O.xml=U.responseXML,O.data=U.responseXML):O.data=U.response:(O.text=U.responseText,O.data=U.responseText),"responseURL"in U&&(O.finalUrl=U.responseURL)},H=function(){p.status=O.status,p.statusText=O.statusText},j=function(){"text"in O&&(p.responseText=O.text),"xml"in O&&(p.responseXML=O.xml),"data"in O&&(p.response=O.data),"finalUrl"in O&&(p.responseURL=O.finalUrl)},a=function(e,t){for(;e>i&&i<4;)p[f]=++i,1===i&&p[o]("loadstart",{}),2===i&&H(),4===i&&(H(),j()),p[o]("readystatechange",t||{}),4===i&&setTimeout(s,0)},s=function(){v||p[o]("load",{}),p[o]("loadend",{}),v&&(p[f]=0)},i=0,S=function(t,n){var r,o;4===t?(r=L.listeners(e),(o=function(){var e;return r.length?2===(e=r.shift()).length?(e(C,O),o()):3===e.length&&C.async?e(C,O,o):o():a(4,n)})()):a(t,n)},p=(C={}).xhr=r(),U.onreadystatechange=function(e){U[f];try{2===U[f]&&T()}catch(e){}4===U[f]&&(M=!1,T(),w()),S(U[f],e)},g=function(){v=!0},p[d]("error",g),p[d]("timeout",g),p[d]("abort",g),p[d]("progress",function(e){i<3?S(3):p[o]("readystatechange",e||{})}),("withCredentials"in U||L.addWithCredentials)&&(p.withCredentials=!1),p.status=0;for(N=0,k=(q=n.concat(c)).length;N<k;N++)u=q[N],p["on"+u]=null;return p.open=function(e,t,n,r,o){i=0,v=!1,M=!1,C.headers={},C.headerNames={},C.status=0,(O={}).headers={},C.method=e,C.url=t,C.async=!1!==n,C.user=r,C.pass=o,S(1)},p.send=function(e){var r,o,i,s,a,u,d,f;for(u=0,d=(f=["type","timeout","withCredentials"]).length;u<d;u++)(i="type"===(o=f[u])?"responseType":o)in p&&(C[o]=p[i]);C.body=e,a=function(){var e,t,r,s,a,u;for(x(n,U,p),p.upload&&x(n.concat(c),U.upload,p.upload),M=!0,U.open(C.method,C.url,C.async,C.user,C.pass),r=0,s=(a=["type","timeout","withCredentials"]).length;r<s;r++)i="type"===(o=a[r])?"responseType":o,o in C&&(U[i]=C[o]);for(e in u=C.headers)t=u[e],e&&U.setRequestHeader(e,t);C.body instanceof l&&(C.body=C.body.fd),U.send(C.body)},r=L.listeners(t),(s=function(){var e,t;return r.length?((e=function(e){if("object"===(void 0===e?"undefined":R(e))&&("number"==typeof e.status||"number"==typeof O.status))return m(e,O),E.call(e,"data")<0&&(e.data=e.response||e.text),void S(4);s()}).head=function(e){return m(e,O),S(2)},e.progress=function(e){return m(e,O),S(3)},1===(t=r.shift()).length?e(t(C)):2===t.length&&C.async?t(C,e):e()):a()})()},p.abort=function(){A=-1,M?U.abort():p[o]("abort",{})},p.setRequestHeader=function(e,t){var n,r;n=null!=e?e.toLowerCase():void 0,r=C.headerNames[n]=C.headerNames[n]||e,C.headers[r]&&(t=C.headers[r]+", "+t),C.headers[r]=t},p.getResponseHeader=function(e){var t;return t=null!=e?e.toLowerCase():void 0,O.headers[t]},p.getAllResponseHeaders=function(){return y(O.headers)},U.overrideMimeType&&(p.overrideMimeType=function(){return U.overrideMimeType.apply(U,arguments)}),U.upload&&(p.upload=C.upload=r()),p},module.exports=L;
...
},{"../vendor/xhook":4,"./config":20}],29:[function(require,module,exports) {
var e=require("../vendor/xhook"),t=require("./config"),r=require("./util"),o=r.log,a=r.warn,n=r.toRegExp,s=r.strip,i=r.parseUrl,d=r.COMPAT_VERSION,u=!1,l={};exports.addMasters=function(e){if(window!==window.parent)for(var t in u||(u=!0,o("now handling incoming sockets..."),window.parent.postMessage("XDPING_"+d,"*")),e){var r=e[t];"file://"===t&&"*"!==r&&(a("file protocol only supports the * path"),r="*"),o("adding master: "+t),l[t]=r}else a("slaves must be in an iframe")},t.masters=exports.addMasters,exports.handleSocket=function(t,r){if(u){"null"!==t&&"file:"!==t||(t="file://"),o('handle socket for "'+t+'"');var d=null;for(var p in l){var f=l[p];try{if(n(p).test(t)){d=n(f);break}}catch(e){}}d?(r.once("request",function(t){o("request: "+t.method+" "+t.url);var n=i(t.url);if(!n||!d.test(n.path))return a("blocked request to path: '"+n.path+"' by regex: "+d),void r.close();var u=new XMLHttpRequest;for(var l in u.open(t.method,t.url),u.addEventListener("*",function(e){return r.emit("xhr-event",e.type,s(e))}),u.upload&&u.upload.addEventListener("*",function(e){return r.emit("xhr-upload-event",e.type,s(e))}),u.onreadystatechange=function(){if(4===u.readyState){var t={status:u.status,statusText:u.statusText,data:u.response,headers:e.headers(u.getAllResponseHeaders())};try{t.text=u.responseText}catch(e){}return r.emit("response",t)}},r.once("abort",function(){return u.abort()}),t.withCredentials&&(u.withCredentials=!0,t.slaveCookie&&(t.headers[t.slaveCookie]=document.cookie)),t.timeout&&(u.timeout=t.timeout),t.type&&(u.responseType=t.type),t.headers){var p=t.headers[l];u.setRequestHeader(l,p)}if(t.body instanceof Array&&"XD_FD"===t.body[0]){var f=new e.FormData,c=t.body[1];Array.from(c).forEach(function(e){if("XD_BLOB"===e[0]&&4===e.length){var t=new Blob([e[2]],{type:e[3]});(e=e[1])[1]=t}f.append.apply(f,e)}),t.body=f}u.send(t.body||null)}),o("slave listening for requests on socket: "+r.id)):a("blocked request from: '"+t+"'")}};
...
},{"../vendor/xhook":4,"./config":20,"./util":17,"./slave":29}],28:[function(require,module,exports) {
...
},{"./config":20,"./util":17,"./master":28,"./slave":29}],3:[function(require,module,exports) {
